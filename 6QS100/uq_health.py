...
total_url='https://about.uq.edu.au/faculties-institutes/hmbs/about/schools-institutes-centres'
result=[]
...
dl_list=tree.xpath('//*[@id="block-uq-standard-theme-content"]/article/div/div[2]/div/div[2]/div[1]/div/div/ul')
i = 0
for dl in dl_list:
    li_list=dl.xpath('./li')
    i += 1
...
file_path = f"{work_dir}/uq_health.xlsx"
