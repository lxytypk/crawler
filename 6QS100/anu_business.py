...
total_url='https://clgp.anu.edu.au/'
result=[]
...
dl_list=tree.xpath('//*[@id="block-webstyle-content"]/article/div/div[6]/div/div/div/div/div/div/div/div/div/div/div/div/div')
for a in dl_list:
    institution=a.xpath('./div/div/div[1]/h3/a/text()')[0].strip()
    institution="Department of "+institution
    print(institution)
    
    institution_url = a.xpath('./div/div/div[1]/h3/a/@href')[0]
...
file_path = f"{work_dir}/anu_business.xlsx"
