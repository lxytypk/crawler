...
total_url='https://sils.uva.nl/research/research-groups/research-groups-copy.html'
result=[]
...
dl_list=tree.xpath('//*[@id="area-main"]/div[4]/div/div/div[2]/div/div[@class="c-link__zone textflow"]')
for dl in dl_list:
    ...
    for a in li_list:
        ...
        if not institution_url.startswith('http'):
            institution_url = 'https://sils.uva.nl' + institution_url
...
file_path = f"{work_dir}/uva_sils.xlsx"
