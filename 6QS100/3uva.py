...
total_url='https://www.uva.nl/en/about-the-uva/organisation/organisation.html'
...
dl_list=tree.xpath('//*[@id="area-main"]/div[3]/div[2]/div/div/div/ul/li')
for a in dl_list:
    institution=a.xpath('./article/a//div[@class="c-card__content"]/header/h2//text()')[0].strip()
    if not institution.startswith('Faculty of'):
        institution = 'School of ' + institution
    print(institution)
