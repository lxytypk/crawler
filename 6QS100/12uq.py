...
total_url='https://about.uq.edu.au/faculties-schools-institutes-centres'
...
dl_list=tree.xpath('//div[@class="uq-sidebar-layout__main"]/div[position()>1 and position()<7]')
for dl in dl_list:
    li_list=dl.xpath('./div/div/section/article/div[1]/ul/li')
    for a in li_list:
...
dl_list=tree.xpath('//div[@class="uq-sidebar-layout__main"]/div[7]/div[2]/div')
for a in dl_list:
    institution=a.xpath('./div/div[2]/h3/a/text()')[0].strip()
    print(institution)
    
    institution_url = a.xpath('./div/div[2]/h3/a/@href')[0]
    print(institution_url)
