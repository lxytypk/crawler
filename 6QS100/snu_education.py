...
#让浏览器发起一个指定url对应的请求
bro.get('https://edu.snu.ac.kr/en/academics/department-offices-faculty/')
#获取浏览器当前页面的页面源码数据
page_text=bro.page_source

total_url='https://edu.snu.ac.kr/en/academics/department-offices-faculty/'
result=[]
...
dl_list=tree.xpath('/html/body/div[2]/section[3]/div[2]/div/div/div/div/div/article')
for a in dl_list:
    sleep(0.5)
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://edu.snu.ac.kr/en/academics' + institution_url
...
file_path = f"{work_dir}/snu_education.xlsx"
