...
total_url='https://weinberg.northwestern.edu/research/laboratories-facilities/'
result=[]
...
dl_list=tree.xpath('//div[@class="feature-two-col blue-background"]/article')
for a in dl_list:
    institution=a.xpath('./div/h2/text()')[0].strip()
...
file_path = f"{work_dir}/northwestern_weinberg.xlsx"
