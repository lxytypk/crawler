...
total_url='https://social.snu.ac.kr/en/organization/'
result=[]
...
dl_list=tree.xpath('//*[@id="menu-item-3662"]/ul/li')
for a in dl_list:
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://social.snu.ac.kr' + institution_url
...
file_path = f"{work_dir}/snu_social.xlsx"
