...
total_url='https://engineering.nyu.edu/'
result=[]
...
dl_list=tree.xpath('//*[@id="toggle-1"]/div/div/div[1]/ul/li')
for a in dl_list:
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://engineering.nyu.edu' + institution_url
...
file_path = f"{work_dir}/nyu_engineering.xlsx"
