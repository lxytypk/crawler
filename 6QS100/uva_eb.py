...
total_url='https://www.uva.nl/en/about-the-uva/organisation/faculties/faculty-of-economics-and-business/about-eb/about-economics-and-business.html'
result=[]
...
dl_list=tree.xpath('//*[@id="area-main"]/div[5]/div[2]/div/div/div/ul/li')
for a in dl_list:
    institution=a.xpath('./article/a/div/div/header/h2/span/text()')[0].strip()
    institution = 'Department of ' + institution
    print(institution)
    
    institution_url = a.xpath('./article/a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url = 'https://www.uva.nl' + institution_url
...
file_path = f"{work_dir}/qqqq.xlsx"
