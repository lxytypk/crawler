...
total_url='https://hkust.edu.hk/academics'
...
dl_list=tree.xpath('//*[@id="block-hkust-content"]/article/div/div[2]/div[4]/div/div/div[2]/div[2]/div[1]/div')
for a in dl_list:
    institution=a.xpath('./div[2]/p/text()')[0].strip()
    print(institution)
    
    institution_url = a.xpath('./div[3]/div[2]/a/@href')[0]
