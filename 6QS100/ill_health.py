...
total_url='https://ahs.illinois.edu/ahs-directory'
result=[]
...
dl_list=tree.xpath('/html/body/div[1]/div/main/div[1]/div/article/div[2]/div/article/div/div[2]/ul/li')
for a in dl_list:
    institution=a.xpath('./div/div/span/a/text()')[0].strip()
    print(institution)
    
    institution_url = a.xpath('./div/div/span/a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url = 'https://ahs.illinois.edu' + institution_url
...
file_path = f"{work_dir}/ill_health.xlsx"
