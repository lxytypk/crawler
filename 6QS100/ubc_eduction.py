...
total_url='https://educ.ubc.ca/contact/education-administrative-directory/'
result=[]
...
dl_list=tree.xpath('//*[@id="menu-item-75011"]/ul/li')
for a in dl_list:
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://educ.ubc.ca/' + institution_url
...
file_path = f"{work_dir}/ubc_eduction.xlsx"
