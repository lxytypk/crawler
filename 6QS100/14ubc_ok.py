...
total_url='https://ok.ubc.ca/academics/faculties-and-schools/'
...
dl_list=tree.xpath('//div[@id="ok-accordion-1"]/div')
for dl in dl_list:
    nn=dl.xpath('./div[1]/a/text()')[0].strip()
    li_list=dl.xpath('./div[2]/div/ul/li')
    if len(li_list) == 0:
        institution_url = dl.xpath('./div[2]/div/h4/a/@href')[0]
