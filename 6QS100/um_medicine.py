...
total_url='https://medicine.um.edu.my/nursing-science-department'
result=[]
...
dl_list=tree.xpath('//*[@id="rs-header"]/div[2]/div/div/div/div/nav/ul/li[5]/ul/li')
for dl in dl_list:
    a_list=dl.xpath('./ul/li')
    # print(a_list)
    for a in a_list:
        ...
        institution_url="https://medicine.um.edu.my/"+institution_url
