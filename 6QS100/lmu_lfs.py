...
total_url='https://www.en.soziologie.uni-muenchen.de/staff_neu/index.html'
result=[]
...
dl_list=tree.xpath('//*[@id="content"]/div[2]/div')

for a in dl_list:
    try:
        institution=a.xpath('./h2/a/text()')[0].strip()
        print(institution)
        
        institution_url = a.xpath('./h2/a/@href')[0]
...
file_path = f"{work_dir}/lmu_lfs.xlsx"
