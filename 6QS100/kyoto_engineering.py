...
total_url='https://www.t.kyoto-u.ac.jp/en/divisions/departments'
result=[]
...
dl_list=tree.xpath('//*[@id="content-core"]/div/article')
for a in dl_list:
    institution=a.xpath('./a/h2/text()')[0].strip()
    institution='Department of '+institution
    print(institution)
    
    institution_url = a.xpath('./a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url = 'https://www.t.kyoto-u.ac.jp' + institution_url
...
file_path = f"{work_dir}/kyoto_engineering.xlsx"
