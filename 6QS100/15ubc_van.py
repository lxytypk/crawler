...
total_url='https://www.ubc.ca/our-campuses/vancouver/directories/faculties-schools.html'
...
dl_list=tree.xpath('//*[@id="content"]/div/div/div[1]/ul[1]/li')
for a in dl_list:
...
file_path = f"{work_dir}/ubc_van.xlsx"
