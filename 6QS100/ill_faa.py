...
total_url='https://faa.illinois.edu/about/administrativeoffices/'
result=[]
...
dl_list=tree.xpath('//*[@id="content"]/div[1]/div/div[3]/div/div[3]/div/div')
for a in dl_list:
    institution=a.xpath('./div/div/div[1]/h2/a/text()')[0].strip()
    print(institution)
    
    institution_url = a.xpath('./div/div/div[1]/h2/a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url = 'https://faa.illinois.edu' + institution_url
...
file_path = f"{work_dir}/ill_faa.xlsx"
