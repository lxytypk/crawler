...
total_url='https://www.tudelft.nl/en/research/faculties-and-institutes'
...
dl_list=tree.xpath('//div[@class="row   grid  multiRowGrid layout-0"]/div')
for a in dl_list:
    institution=a.xpath('./div/div/div/a/div/section/h3/text()')[0].strip()
    print(institution)
    
    institution_url = a.xpath('./div/div/div/a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url='https://www.tudelft.nl'+institution_url
