...
total_url='https://www.cuhk.edu.hk/english/faculties/medicine.html'
result=[]
...
dl_list=tree.xpath('//*[@id="main_content"]/ul/li[4]/div/ul/li')
for a in dl_list:
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://www.cuhk.edu.hk' + institution_url
...
file_path = f"{work_dir}/cuhk_medicine.xlsx"
