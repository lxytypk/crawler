...
total_url='https://www.northwestern.edu/academics/colleges-and-schools.html'
...
dl_list=tree.xpath('//div[@class="flip-cards-3 square"]/div')
for a in dl_list:
    institution=a.xpath('./a/div/div[2]/h3/text()')[0].strip()
    print(institution)
