...
total_url='https://www.feinberg.northwestern.edu/faculty-profiles/depts.html'
result=[]
...
dl_list=tree.xpath('//*[@id="main-content"]/section/div[2]/div[1]/ul/li')
for a in dl_list:
    ...
    if not institution_url.startswith('http'):
        institution_url = 'https://www.feinberg.northwestern.edu' + institution_url
...
file_path = f"{work_dir}/northwestern_medicine.xlsx"
