...
dl_list=tree.xpath('//*[@id="incHeader"]/nav/div[7]/dl[1]/dd[position()<4]')
for dl in dl_list:
    li_list=dl.xpath('./a')
    for a in li_list:
        institution=a.xpath('./text()')[0].strip()
        institution='College of '+institution
        print(institution)
        
        institution_url = a.xpath('./@href')[0]
