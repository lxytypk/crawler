...
#让浏览器发起一个指定url对应的请求
bro.get('https://www.monash.edu/about/structure/faculties')
#获取浏览器当前页面的页面源码数据
page_text=bro.page_source

total_url='https://www.monash.edu/about/structure/faculties'
...
dl_list=tree.xpath('//*[@id="content_container_52281_52281"]/div/div')
for a in dl_list:
    sleep(1)
    institution=a.xpath('./h2/text()')[0].strip()
    print(institution)
    institution='School of '+institution
    print(institution)
    
    institution_url = a.xpath('./ul/li[last()]/a/@href')[0]
    if not institution_url.startswith('http'):
        institution_url='https://www.monash.edu'+institution_url
...
file_path = f"{work_dir}/qs122.xlsx"
