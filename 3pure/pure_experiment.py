...
for i in range(3):
    ...
    '''change'''
    if i ==0:
        website = "https://fis.dshs-koeln.de/en/persons"
        xpath_list=None#'//*[@id="main-content"]/div/div[2]/nav/ul/li[3]/a'
    else:
        website=f"https://fis.dshs-koeln.de/en/persons/?page={i}"
    ...
    for i in range(reseacher_len):
        if len(tree.xpath(f'//*[@id="main-content"]/div/div[2]/ul/li[{i+1}]/div/div/ul[2]/li/a'))!=0:
            ...
            college=tree.xpath(f'//*[@id="main-content"]/div/div[2]/ul/li[{i+1}]/div/div/ul[2]/li/a')[0].get('href').split('/')[5]
        ...
        if len(tree.xpath(f'//*[@id="main-content"]/div/div[2]/ul/li[{i+1}]/div/div/h3/a')):
            ...
            title=None
        link=tree.xpath(f'//*[@id="main-content"]/div/div[2]/ul/li[{i+1}]/div/div/h3/a')[0].get('href')
